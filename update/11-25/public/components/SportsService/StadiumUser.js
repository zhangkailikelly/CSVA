...
var _components = {
    StadiumUser: {
        displayName: "StadiumUser"
    }
};

var _CUsersKellyZhangDesktopCSVAPublicNode_modulesReactTransformHmrLibIndexJs2 = (0, _index6.default)({
    filename: "C:/Users/kellyZhang/Desktop/CSVA/public/components/SportsService/StadiumUser.jsx",
...
var StadiumUser = _wrapComponent("StadiumUser")(function (_React$Component) {
    _inherits(StadiumUser, _React$Component);

    function StadiumUser() {
        var _ref;

        _classCallCheck(this, StadiumUser);

        for (var _len = arguments.length, arg = Array(_len), _key = 0; _key < _len; _key++) {
            arg[_key] = arguments[_key];
        }

        return _possibleConstructorReturn(this, (_ref = StadiumUser.__proto__ || Object.getPrototypeOf(StadiumUser)).call.apply(_ref, [this].concat(arg)));
    }

    _createClass(StadiumUser, [{
        key: "render",
                ...
                _react3.default.createElement(
                    ...
                    _react3.default.createElement(
                        ...
                        _react3.default.createElement(
                            ...
                            _react3.default.createElement(
                                Link,
                                { to: "/StadiumUser", onlyActiveOnIndex: true, className: "link" },
                                "\u573A\u9986\u57FA\u7840\u4FE1\u606F",
                                _react3.default.createElement("span", {
                                    className: "pull-right glyphicon glyphicon-menu-right", "aria-hidden": "true" })
                            )
                        ),
                        _react3.default.createElement(
                            "li",
                            ...
                            _react3.default.createElement(
                                Link,
                                { to: "/StadiumUser/2", className: "link" },
                                "\u4F18\u60E0\u4FE1\u606F\u516C\u544A",
                                _react3.default.createElement("span", {
                                    className: "pull-right glyphicon glyphicon-menu-right", "aria-hidden": "true" })
                            )
