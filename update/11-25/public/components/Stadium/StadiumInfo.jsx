		...
		return (
			<div>
			    <form id="stadiumAuditViewForm" className="animated fadeInDown">
					...
					<Link to="/manage/stadium"><button onClick={()=>{this.checkdatas(2)}} type="button" style={{margin:"0 0 40px 190px"}} id="auditYesBtn" className="BlueBut">审核通过</button></Link>
					<Link to="/manage/stadium"><button onClick={()=>{this.checkdatas(3)}} type="button" style={{margin:"0 0 40px 40px"}} id="auditNoBtn" className="BlueBut">审核不通过</button></Link>
				</form>
			</div>
			)
	}
