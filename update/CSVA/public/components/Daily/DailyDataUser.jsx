			...
			<div>
				...
				<div className="topSearch RightInfo mLR MB">
				  <form className="form-inline MT" id="dailyOpenTimeForm">
				    ...
				    <div className="form-group input-group-sm">
				       <label style={{width:'98px',textAlign:"center"}}>-</label>
				       <input type="text" className="leastInput mydate" />
				    </div>
				...
				<div className="clearfix" style={{overflow:"hidden"}}>
					<Calendar/>
					<div className="pull-left rightCale" style={{marginTop:'15px'}}>
						<p><span className="RTitle">日期：</span><span id="currCheckDay"></span><br/></p>
						<p><span className="RTitle">开放时间：</span><span id="currCheckDayHour">13小时</span><br/></p>
						<p><span className="RTitle">参与活动人次：</span><span id="dailyUser">{0}</span></p>
					</div>
				</div>
