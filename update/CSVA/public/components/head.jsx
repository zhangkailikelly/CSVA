...
export default class Header extends React.Component{
  ...
  render(){
    return (<div className="HeaderT">
                ...
                <p className="pull-right UserExit"><img src={userSrc} style={{margin:'-3px 10px 0 0'}} /><em>admin@admin.com</em>  | <a className="exitL" name="" href="/"><img src={exitSrc} title="退出" /></a></p>
            </div>)
        }
}
