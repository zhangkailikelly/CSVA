...
export default class TotalInfo extends React.Component{
	constructor(){
		super();
	}
	render(){
		return (
			<div>
				...
				<div id="stadiumWrap" className="MT table-responsive normal mLR tbodyLeft">
				    ...
				    <tbody>
				      <tr>
				        <td rowSpan="2" style={{textAlign: "center",verticalAlign:"middle"}}>场地开放</td>
				        <td>*1.1开放面积</td>
				      ...
				      <tr>
				        <td rowSpan="2" style={{textAlign: "center",verticalAlign:"middle"}}>活动承载</td>
				        <td>*2.1 体育赛事</td>
				        <td>举办活承办体育赛事数量</td>
				      ...
				      <tr>
				        <td  rowSpan="2" style={{textAlign: "center",verticalAlign:"middle"}}>体育服务</td>
				        <td>*3.1 体育培训</td>
				        <td>体育培训的人次</td>
