...
module.exports={
	entry:{
		...
		manage:"./manage.js",
		login:"./login.js",
		vendors:["react","react-router","react-dom","react-redux","redux"]//分离第三方依赖，单独打包
	},
	output:{
	...
	plugins:[
		...
		new html({
			...
			template: __dirname + '/manage-template.html',//插件没有配置loader时默认支持的ejs模板引擎
			inject:"body",//所有的 javascript 资源将被放置到 body 元素的底部
			filename: "index.html",//输出文件路径为output.path
		...
		new html({
			title: "users",
			//favicon:"",// 添加特定的 favicon 路径到输出的 HTML 文件中
			template: __dirname + '/users-template.html',//插件没有配置loader时默认支持的ejs模板引擎
			inject:"body",//所有的 javascript 资源将被放置到 body 元素的底部
