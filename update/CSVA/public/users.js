...
import ReactRouter,{Router,Route,IndexRedirect,Redirect,browserHistory,IndexRoute} from "react-router";
//展示组件
			...
			<Router history={browserHistory}>
				<Route path="/users" component={App}>
				    ...
				    <Route path="Daily" component={Daily}>
						...
						<Route path="2/*" component={DailyAddUser}/>
						<Redirect from="/users/Daily/*" to="/users/Daily"/>
					</Route>
					{/*活动承载*/}
					<Route path="SportsActive" component={SportsActive}>
						...
						<Redirect from="/users/SportsActive/*" to="/users/SportsActive"/>
					</Route>
					{/*体育服务*/}
					<Route path="SportsService" component={SportsService}>
						...
						<Redirect from="/users/SportsService/*" to="/users/SportsService"/>
					</Route>
					{/*场馆管理*/}
					<Route path="stadium" component={StadiumUser}>
        			   ...
        			   <Route path='3/*' component={AddmationList}/>
						<Redirect from="/users/stadium/*" to="/users/stadium"/>
					</Route>
				    {/*汇总数据*/}
					<Route path="Total" component={Total}>
						...
						<Redirect from="/users/Total/*" to="/users/Total"/>
					</Route>
					<Redirect from="/users/*" to="/users/Daily"/>
				</Route>
			</Router>
		</Provider>,
		rootElement
