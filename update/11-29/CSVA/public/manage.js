...
import ReactRouter,{Router,Route,Redirect,IndexRedirect,Link,hashHistory,browserHistory,IndexRoute} from "react-router";
//展示组件
//登录
    ...
    <Provider store={store}>
        <Router history={browserHistory}>
            <Route path="/manage" component={App}>
                <IndexRedirect  to="/manage/stadium"/>
                {/*场馆管理*/}
                <Route path="stadium" component={Stadium}>
                    ...
                    <Redirect from="/manage/stadium/*" to="/manage/stadium"/>
                </Route>
                {/*评分规则*/}
                <Route path="Rule" component={Rule}>
                    <IndexRoute component={RuleAdd}/>
                    <Route path="2/*" component={RuleList}/>
                    <Redirect from="/manage/Rule/*" to="/manage/Rule"/>
                ...
                <Route path="SportsService" component={SportsService}>
                    ...
                    <Redirect from="/manage/SportsService/*" to="/manage/SportsService"/>
                </Route>
                {/*已注释
                ...
                <Redirect from="/manage/*" to="/manage/stadium"/>
            </Route>
        </Router>
    </Provider>,
    rootElement
