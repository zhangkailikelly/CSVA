				...
				<div className="topSearch RightInfo mLR MB">
				    <form className="form-inline" id="gameSearchForm">
				        <div className="form-group">
			            	<label >培训名称</label>
			            	<input type="text" className="form-control" placeholder="培训名称" />
			            </div>
			            <div className="form-group">
			            	<label>培训机构名称</label>
			            ...
			            <div className="form-group">
			            	<label>培训项目</label>
			            	<input type="text" className="form-control" placeholder="培训项目" />
			            </div>
