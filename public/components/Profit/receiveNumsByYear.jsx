...
export default class receiveNumsByYear extends React.Component{
	constructor(){
		super();
	}
	render(){
		return (
			<div>
				<div className="location">
				  <h3><label> 综合效益 </label> &gt; <label>  接待人次增长 </label></h3>
				</div>
				<form className="form-horizontal" id="receiveNumsForm">
				  <div className="form-group MT">
				    <label className="col-sm-2 control-label">今年接待量</label>
				  ...
				  <div className="form-group">
				    <label className="col-sm-2 control-label">去年接待量</label>
				    <div className="col-sm-4">
